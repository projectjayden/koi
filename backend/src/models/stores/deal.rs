...
impl Deal {
  pub fn new(uuid: String, store_uuid: String, name: String, description: Option<String>, start_date: u32, end_date: u32, r#type: u8, value_1: u8, value_2: Option<u8>) -> Self {
    Self {
      uuid,
      store_uuid,
      name,
