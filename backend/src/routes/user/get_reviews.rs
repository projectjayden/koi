use crate::{ guards::auth::AuthenticatedUser, models::users::Review };
...
pub async fn get_reviews(mut db: Connection<Db>, user: AuthenticatedUser, data: Json<ReviewInput>) -> Result<Json<(usize, Vec<Review>)>, Status> {
